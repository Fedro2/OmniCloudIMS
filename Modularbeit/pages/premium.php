...
<header>
    <nav class="navbar">
        <!-- Logo -->
        <a href="index.php"> <img src="../assets/OmniLogo.png" class="omnilogo" alt="logo"> </a>
...
<main class="preis-main">
    ...
    <form action="premium.php" method="post" class="price">
        <h2>Premium-Angebot</h2>
        ...
        <label for="cores">CPU-Kerne:</label><br>
        ...
        <select id="ram" name="ram">
            ...
            <option value="1024">1'024 (10 CHF)</option>
            <option value="2048">2'048 (20 CHF)</option>
            <option value="4096">4'096 (40 CHF)</option>
            <option value="8192">8'192 (80 CHF)</option>
            <option value="16384">16'384 (160 CHF)</option>
            <option value="32768">32'768 (320 CHF)</option>
            <option value="65536">65'536 (640 CHF)</option>
            <option value="131072">131'072 (1'280 CHF)</option>
        </select><br>
        ...
        <select id="ssd" name="ssd">
            ...
            <option value="240">240 (120 CHF)</option>
            <option value="500">500 (250 CHF)</option>
            <option value="1000">1'000 (500 CHF)</option>
            <option value="2000">2'000 (1'000 CHF)</option>
            <option value="4000">4'000 (2'000 CHF)</option>
            <option value="8000">8'000 (4'000 CHF)</option>
            <option value="16000">16'000 (8'000 CHF)</option>
        </select><br>
        <p>+ 2% (aufgrund des Aufwands)</p>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            setTimeout(function() {
                const dialog = document.getElementById('antworten'); // Corrected id here
                if (dialog) {
